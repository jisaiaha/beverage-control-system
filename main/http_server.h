 ...
 * @return: pdTrue if an item was successfullly sent to the queue, otherwise pdFalse
 */
...
/*
 * Timer callback function: calls esp_restart upon successful firmware update
 */
